...
export default class RemoteConfigAnimation extends Component {
    ...
    render() {
        return (
            <div>
                <svg width="1129px" height="352px" viewBox="0 0 1129 352">
                    ...
                    <defs>
                        ...
                        <rect id="path-2" x={0} y={21.75} width={444} height={278.25} rx={6} />
                        ...
                        <rect id="path-7" x={0} y={0} width={300} height={112} rx={2.88000011} />
                        <filter
                            x="-10.2%"
                            y="-23.7%"
                            width="120.3%"
                        ...
                        <rect id="path-9" x={0} y={23} width={200} height={40} rx={3} />
                        <filter
                            x="-20.8%"
                            y="-91.2%"
                            width="141.5%"
                        ...
                        />
                        <path
                            d="M14.0068455,44 C13.4507801,44 13,43.5561352 13,43 L13,43 C13,42.4477153 13.4499488,42 14.0068455,42 L25.9931545,42 C26.5492199,42 27,42.4438648 27,43 L27,43 C27,43.5522847 26.5500512,44 25.9931545,44 L14.0068455,44 Z"
                            id="path-13"
                        />
                        <path
                            d="M181,44 L181,49.009222 C181,49.5564136 180.556135,50 180,50 L180,50 C179.447715,50 179,49.5490248 179,49.009222 L179,44 L173.990778,44 C173.443586,44 173,43.5561352 173,43 L173,43 C173,42.4477153 173.450975,42 173.990778,42 L179,42 L179,36.990778 C179,36.4435864 179.443865,36 180,36 L180,36 C180.552285,36 181,36.4509752 181,36.990778 L181,42 L186.009222,42 C186.556414,42 187,42.4438648 187,43 L187,43 C187,43.5522847 186.549025,44 186.009222,44 L181,44 Z"
                            id="path-15"
                        />
                        <filter
                            x="-29.8%"
                        ...
                        <rect id="path-18" x={0} y={0} width={200} height={40} rx={3} />
                        <path
                            d="M1,3 L1,37 C1,38.1045695 1.8954305,39 3,39 L197,39 C198.104569,39 199,38.1045695 199,37 L199,3 C199,1.8954305 198.104569,1 197,1 L3,1 C1.8954305,1 1,1.8954305 1,3 Z M2,0 L198,0 C199.104569,-2.02906125e-16 200,0.8954305 200,2 L200,38 C200,39.1045695 199.104569,40 198,40 L2,40 C0.8954305,40 1.3527075e-16,39.1045695 0,38 L0,2 C-1.3527075e-16,0.8954305 0.8954305,2.02906125e-16 2,0 Z"
                            id="path-20"
                        />
                    ...
                    <g
                        ...
                        fillRule="evenodd"
                    >
                        <g id="Artboard" transform="translate(-159.000000, -82.000000)">
                            <g id="remote-config" transform="translate(178.000000, 103.000000)">
                                <g
                                    id="browser"
                                    filter="url(#filter-1)"
                                ...
                                >
                                    ...
                                    <use id="bg" fill="#22354A" xlinkHref="#path-2" />
                                    <rect
                                        id="header-bg"
                                        fill="#132333"
                                        mask="url(#mask-3)"
                                        ...
                                        height={52.5}
                                    />
                                    <g id="bullet-train-logo" className="logo" mask="url(#mask-3)">
                                ...
                                <g id="code-block" transform="translate(0.000000, 94.000000)">
                                    <g id="code-bg">
                                        <use
                                            fill="black"
                                            fillOpacity={1}
                                            ...
                                            xlinkHref="#path-7"
                                        />
                                        <use fill="#22354A" fillRule="evenodd" xlinkHref="#path-7" />
                                    </g>
                                </g>
                                <g id="ui-controls" transform="translate(370.000000, 73.000000)">
                                    <g id="value" transform="translate(0.000000, 91.000000)">
                                        ...
                                        <g id="Mask" fill="black" fillOpacity={1}>
                                            <use filter="url(#filter-10)" xlinkHref="#path-9" />
                                        </g>
                                        <rect
                                        ...
                                        <use id="minus" fill="#C2D1D9" xlinkHref="#path-13" />
                                        <mask id="mask-16" fill="white">
                                            <use xlinkHref="#path-15" />
                                        </mask>
                                        <use id="plus" fill="#C2D1D9" xlinkHref="#path-15" />
                                    </g>
                                    <g id="id">
                                        <text
                                            id="ID"
