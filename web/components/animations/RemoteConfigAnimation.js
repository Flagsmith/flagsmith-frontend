...
export default class RemoteConfigAnimation extends Component {
    ...
    render() {
        return (
            <div>
                {/*<svg width="740px" height="300px" viewBox="0 0 740 300">*/}
                    {/*<title>{'Group 5'}</title>*/}
                    {/*<desc>{'Created with Sketch.'}</desc>*/}
                    {/*<defs>*/}
                        {/*<rect id="path-1" x={0} y={21.75} width={444} height={278.25} rx={6} />*/}
                        ...
                        {/*>*/}
                            ...
                            {/*</feMerge>*/}
                        {/*</filter>*/}
                        {/*<rect id="path-7" x={0} y={0} width={200} height={40} rx={3} />*/}
                        {/*<path*/}
                            ...
                            {/*id="path-9"*/}
                        {/*/>*/}
                        {/*<rect id="path-11" x={0} y={0} width={200} height={40} rx={3} />*/}
                        {/*<filter*/}
                            {/*x="-20.8%"*/}
                            {/*y="-91.2%"*/}
                            {/*width="141.5%"*/}
