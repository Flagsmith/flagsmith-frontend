                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-md-4 offset-md-1 features-cta">
                            ...
                            <p className="">
                                Bullet Train lets you manage {explain ? <Link className="link" to={"/blog/remote-config-and-feature-flags"}>feature
                                flags</Link>: "feature flags"} and {explain?<Link className="link" to={"/blog/remote-config-and-feature-flags"}>remote
                            ...
                            <p className="">
                                We're <a className="link" href="https://github.com/SolidStateGroup?utf8=%E2%9C%93&q=bullet-train"
