                    ...
                    <div className="container">
                        ...
                        <ol>
                            ...
                            <ul>
                                ...
                                <li><p className={"faint"}>To respond to inquiries, send service notices, and provide customer support</p></li>
                                <li><p className={"faint"}>For audits, regulatory purposes, and compliance with industry standards</p></li>
                                <li><p className={"faint"}>To develop new products</p></li>
                                <li><p className={"faint"}>To send marketing communications</p></li>
                        ...
                        <p className={"faint"}>Bullet Train takes security very seriously, and if you have reason to believe that your data or someone elses data is no longer secure, please contact <a href="mailto:security@bullettrain.io">security@bullettrain.io.</a></p>
                        <p className={"faint"}>In the event of a security breach, we will take take necessary measures to ensure the continued safety of data and contact affected parties within a reasonable amount of time about the scope and scale of the unauthorized disclosure.</p>

                        <h5>Retention Period</h5>
                        <p className={"faint"}>We retain data as necessary to provide the services as described in this policy unless a longer retention is required by law. For personal data, we retain information about you until are no longer a customer, though some data is retained for the purposes of audit. Service data is retained for a period of no more than 30 days, save for data that is required as a part of audit control.</p>
                        <p className={"faint"}>The above principals of how we will manage the data, use the data, protect the data, and remove the data will apply for as long as we control the Personal data.</p>

                        <h5>User of Service by Minors</h5>
                        <p className={"faint"}>Bullet Train's core services are not directed to minors and we request that minors do not provide to us any Personal Data. We rely on our members, when acting in the role of a Data controller, to take responsibility for making sure their users' privacy rights are respected and ensuring that the appropriate disclosures are made about third party collection and use.</p>

                        <h5>Right to Access, View, or Remove Your Information</h5>
                        <p className={"faint"}>You have a right to access the personal information we hold about you. Whenever you use our site or Bullet Train Services, we strive to make sure that your Personal Information is correct. If that information is wrong, we give you tools and methods to update it quickly or delete it, unless that information is necessary for legal or business purposes. When updating your Personal Information, we may ask you to verify your identity before making changes. We may reject requests that are unreasonably repetitive, require disproportionate technical effort (for example, developing new systems or fundamentally changing our existing practice), risk the privacy of others, or would be extremely impractical (e.g. requests concerning information on our backup systems). Because we protect information from accidental or malicious destruction, after data is removed from our servers, it can take some time for that data to be purged.</p>
                        <p className={"faint"}>To request removal of your Personal Information from our site or services, contact us at privacy@bullettrain.io. Bullet Train cares deeply about the sanctity of your data and our privacy team will manage each request on a case by case basis.</p>
                        <p className={"faint"}>We totally understand your right to have us stop contacting you. We endeavor to give you the ability to control the way we contact you. You may use the the links at the bottom of each communication to opt-out of further communications.</p>
                        <p className={"faint"}>If you are a user of one of our member's services and need to correct, amend, or delete inaccurate data about you, please contact the member—in this case, they are the data controllers. We will comply with the wishes of our members should they direct us to take action about the modification/removal of collected data.</p>
