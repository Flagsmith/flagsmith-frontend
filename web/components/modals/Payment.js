                                            ...
                                            <div className={"col-md-3 pricing-panel"}>
                                                <div className="panel panel-default">
                                                    <div className="panel-content">
                                                        ...
                                                        <img src="/images/growth.svg" alt="free icon"
                                                        ...
                                                        {!viewOnly ?
                                                            <a href="javascript:void(0)" data-cb-type="checkout"
                                                               ...
                                                               className="pricing-cta blue">Buy</a> : null}
                                                    </div>
                                                    <div className="panel-footer">
                                                        <p className="text-small text-center link-style">What's
                                                            included</p>
                                                        <ul className="pricing-features">
                                                            <li><p>Up to <strong>20,000</strong> requests per month</p>
                                                            </li>
                                        ...
                                        <div className={"col-md-3 pricing-panel"}>
                                            <div className="panel panel-default">
                                                <div className="panel-content">
                                                    ...
                                                    <img src="/images/startup.svg" alt="Startup icon"
                                                         className="pricing-icon"/>
                                                    <p className="pricing-type">$29</p>
                                                    <p className="text-small text-center">billed monthly</p>
                                                    {!viewOnly ? <a href="javascript:void(0)" data-cb-type="checkout"
                                                ...
                                                <div className="panel-footer">
                                                    ...
                                                    <ul className="pricing-features">
                                                        <li><p>Up to <strong>250,000</strong> requests per month</p>
                                                        </li>
                                                        <li><p>Unlimited Administrator Accounts</p></li>
                                                        <li><p>Unlimited Projects</p></li>
                                                        <li><p>Unlimited Environments</p></li>
                                        ...
                                        <div className={"col-md-3 pricing-panel"}>
                                            <div className="panel panel-default">
                                                <div className="panel-content">
                                                    ...
                                                    <img src="/images/layers2.svg" alt="Scale-up icon"
                                                         className="pricing-icon"/>
                                                    <p className="pricing-type">$99</p>
                                                    <p className="text-small text-center">billed monthly</p>
                                                    {!viewOnly ? <a href="javascript:void(0)" data-cb-type="checkout"
                                                                    data-cb-plan-id="scale-up"
                                                                    className="pricing-cta">Buy</a> : null}
                                                </div>
                                                <div className="panel-footer">
                                                    <p className="text-small text-center link-style">What's included</p>
                                                    <ul className="pricing-features">
                                                        <li><p>Up to <strong>2 million</strong> requests per month</p>
                                                        </li>
                                        ...
                                        <div className={"col-md-3 pricing-panel"}>
                                            <div className="panel panel-default">
                                                <div className="panel-content">
                                                    ...
                                                    <img src="/images/cubes.svg" alt="Enterprise icon"
                                                         className="pricing-icon"/>
                                                    <p className="pricing-type">Contact Us</p>
                                                    <p className="text-small text-center">for enterprise pricing</p>
                                                    {!viewOnly ? <a href="mailto:enterprise@bullet-train.io"
                                                                    className="pricing-cta blue">Contact Us</a> : null}
                                                </div>
                                                ...
                                                <div className="panel-footer">
                                                    ...
                                                    <ul className="pricing-features">
                                                        ...
                                                        <li><p>Over <strong>2 million</strong> requests per month</p>
                                                        </li>
