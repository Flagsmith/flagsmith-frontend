                                ...
                                {freeTier && (
                                    <AlertBar>
                                        <div>
                                            ...
                                            free. {pathname.indexOf('organisation-settings') === -1 && this.props.params.projectId && this.props.params.environmentId ? (
                                            <span>Click <Link
                                            ...
                                            {user ? (
                                                    ...
                                                    <Popover className="popover-right"
                                                        ...
                                                        {(toggle) => (
                                                            <div>
                                                                ...
                                                                <div>
                                                                    <Link id="create-org-link" onClick={toggle}
                                                                          to="/create">
                                                                        Create Organisation
                                                                    </Link>
                                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <ul className="nav-list list-unstyled float-right">
                                                        <li><a href="https://github.com/SolidStateGroup?utf8=%E2%9C%93&q=bullet+train" target="_blank"><ion className="icon ion-logo-github"/> Github</a></li>
